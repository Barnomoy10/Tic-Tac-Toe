...
// Prompt the player1 for their name
...
// Test the player1 in the console
const player1 = createPlayer1(player1Name);
console.log(player1);

// Prompt the player2 for their name
...
// Test the player2 in the console
const player2 = createPlayer2(player2Name);
console.log(player2);

// Create a array variable to run a loop till the end of the variable
let arrayVar;
